...
1. I like the languages features of Python 3, particularly 3.5 and above.
>> e.g. """{python} f"Variable x is {x}." """ is much nicer than """{python} "Variable x is {}".format(x)""", and dict packing is also nice.
